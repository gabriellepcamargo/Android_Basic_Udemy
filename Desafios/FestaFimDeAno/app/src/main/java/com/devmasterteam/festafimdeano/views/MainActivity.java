...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.button_confirm) {
            ...
            intent.putExtra(FimDeAnoConstants.PRESENCE, presence);// ERRO
            startActivity(intent);// ERRO, ele apenas criou a intenção mas não deixou ela visivel(executo a intenção)
        }
    }
